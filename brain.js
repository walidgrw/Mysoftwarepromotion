...
function draw(){
  ...
  for(let synapse of brain.synapses){
    ...
    let point2 = between(synapse.from, synapse.to, 0.06 + (synapse.from.size - synapse.from.baseSize) * 0.03);
    let point3 = between(synapse.from, synapse.to, 0.94 - (synapse.to.size - synapse.to.baseSize) * 0.03);
